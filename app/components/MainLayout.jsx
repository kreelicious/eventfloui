...
const navigation = [
  ...
  { name: "CRM", href: "/crm", icon: UsersIcon, current: false },
];
  ...
  return (
    <>
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:block lg:w-20 lg:overflow-y-auto lg:bg-purple-800 lg:pb-4">
            ...
            <ul role="list" className="flex flex-col items-center space-y-1">
              {navigation.map((item) => (
                <li className="group" key={item.name}>
                  ...
                  <span className="pointer-events-none absolute -top-7 left-0 w-max opacity-50 transition-opacity group-hover:opacity-100">
                    {item.name}
                  </span>
                </li>
              ))}
